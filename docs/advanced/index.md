...
All microservices are called over http. There is complete freedom in their implementation subject to the expected API schema — the μEd API specification ([mued.org](https://mued.org/)). All microservices hosted by Lambda Feedback are open source and their code can be found in our public [GitHub repositories](https://github.com/lambda-feedback).
