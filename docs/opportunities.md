...
We are recruiting a _Principal Full Stack Developer_ to work on the [Lambda Feedback project](https://teachingengineers.wordpress.com/2022/07/18/computers-make-us-human/). Work is by contract for up to 40 days per year. The contractor will implement new features, reviewing work by software engineers on the project, and advise on architecture decisions.
...
This is a motivating application in education and uses exciting new technologies. We have work that needs to be completed by July, and will have potential follow on work and commercialisation opportunities if the initial work is successful.
